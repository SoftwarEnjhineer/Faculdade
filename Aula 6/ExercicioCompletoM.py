...
opcaoMenu = int(input('Digite o número correspondete da opção que deseja aplicar: '))
if (opcaoMenu == 1):
    ...
    caracter1 = input('Digite o caracter que deseja contar: ')
    print(f'Esse caracter apararece: {str(string1.count(caracter1))} vezes')
elif (opcaoMenu == 6):
    caracterSubstituido = input('Digite o caracter que será substituído: ')
